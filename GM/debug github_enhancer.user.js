...
// Replace github with Script Name, and edit XXX (e.g. UserScripts-papo) for quick start. (NAME must have word "DEBUG" somewhere, its presence is detected by the script)
// Replace ### as needed.
...
//
// all possible: document-start ['loading'] -> document-body [body exist] *GM N/A) -> document-end (*GM default) ['DOMContentLoaded'/'interactive'] -> document-idle (TM default)
// ###run-at context-menu
// *GM: GreaseMonkey only support three, and v4 has "Limited support", document-end is the only guaranteed.
//      if other are used in GreaseMonkey, script will silently fail
...
//
// @require        file://C:\Users\Papo\Documents\GitHub\UserScripts-papo\GM\github_enhancer.user.js
...
console.log('github_enhancer.user.js: DEBUG meta file');
