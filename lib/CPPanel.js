...
`,
	infopanel: `
		...
		.cp-infopanel > div {
			...
			width: 578px;
		/* just copied for now from old version, maybe remove */
			padding: 0 7px;
			text-align: center;
		}
`
...
constructor(elParent = null, typePanel = 'options', openButton) {
	...
	// todo copied from a dialog on the same Google page. some classnames are probably used. they might change. need to clean this up.
	elCloseBtn.innerHTML = `<a href="#" style="position:absolute;left:11px;top:13px;color:inherit">
	<span style="width:20px;height:20px" class="z1asCe wuXmqc"><svg focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></svg></span></a>`;
