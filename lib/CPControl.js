...
createWidgetAndTextVertical() {
	...
	if (!(this.valueDefault instanceof Object)) {
		this.valueDefault = { imgIdx: 0, div: '---' };
	}
	...
	var elSpan = document.createElement('DIV');
	elSpan.textContent = this.valueDefault['div'];
	...
	this.valuesEl = {img: elImg, span: elSpan};
	this.elements = [elDiv];
	return this;
}
...
updateWidgetAndTextVertical(value) {
	...
	this.valuesEl.img.src = value['imgIdx'];
	this.valuesEl.span.textContent = value['div'];
}
